package ru.mirea.pract_22.controller;
...
import ru.mirea.pract_22.service.EmailService;
import ru.mirea.pract_22.service.MarketService;
...
public class MarketsController {
    ...
    public @ResponseBody ResponseEntity createMarket(Market market) {
        try {
            ...
            emailService.sendSimpleMessage("Market was created", "Market was created");
    ...
    public @ResponseBody ResponseEntity deleteOMarket(int id) {
        try {
            if (marketService.delete(id)) {
                emailService.sendSimpleMessage("Market was deleted", "Market was deleted");
